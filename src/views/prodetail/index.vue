<template>
  <div class="prodetail">
    ...
    <div class="comment">
      ...
      <div class="comment-list">
        <div class="comment-item" v-for="item in commentList" :key="item.comment_id">
          <div class="top">
            <img :src="item.user.avatar_url || defaultAvaImg" alt="">
    ...
    <!-- 商品描述  这里后端传输过来的内容是 html内容格式的文本. v-html -->
    ...
    <div class="footer">
      ...
      <div class="btn-add" @click="addCartHandle">加入购物车</div>
    ...
    <van-action-sheet v-model="showPannel" :title="sheetModel === 'cartModel' ? '购物车' : '购买' ">
      <div class="content">
        <div class="product">
          ...
          <div class="num-box">
            <span>数量</span>
            <CountBox v-model="proCounts"></CountBox>
          </div>
...
export default {
  ...
  computed:  {
    goodsId () {
      // log(this.$route.params.id) 动态路由参数的获取
  ...
  methods: {
    ...
    async getDeatil() {
      ...
      this.detail = detail
      log(`getDeatil data `, this.detail)
